...
- **genre-dna-framework.md 위치**: `${CLAUDE_PLUGIN_ROOT}/skills/novel-design/references/genre-dna-framework.md` (라우터 하위 — big/small 공용)
...
3. `${CLAUDE_PLUGIN_ROOT}/skills/novel-design/references/genre-dna-framework.md`를 읽어 장르 DNA 프레임워크 확인
  ...
  members: [
    {
      ...
      prompt: "당신은 concept-builder 에이전트입니다.
        ...
        ${CLAUDE_PLUGIN_ROOT}/skills/novel-bootstrap/SKILL.md를 읽고 작업 절차와 출력 템플릿을 따르세요.
        ${CLAUDE_PLUGIN_ROOT}/skills/novel-design/references/genre-dna-framework.md를 읽고 장르 DNA 프레임워크를 숙지하세요.
    ...
    },
    {
      ...
      prompt: "당신은 character-architect 에이전트입니다.
        ...
        ${CLAUDE_PLUGIN_ROOT}/skills/novel-character/SKILL.md를 읽고 작업 절차와 출력 템플릿을 따르세요.
        ${CLAUDE_PLUGIN_ROOT}/skills/novel-design/references/genre-dna-framework.md를 읽고 장르 DNA 프레임워크를 숙지하세요.
    ...
    },
    {
      ...
      prompt: "당신은 plot-hook-engineer 에이전트입니다.
        ...
        ${CLAUDE_PLUGIN_ROOT}/skills/novel-plot-hook/SKILL.md를 읽고 작업 절차와 출력 템플릿을 따르세요.
        ${CLAUDE_PLUGIN_ROOT}/skills/novel-design/references/genre-dna-framework.md를 읽고 장르 DNA 프레임워크를 숙지하세요.
...
4. `${CLAUDE_PLUGIN_ROOT}/skills/novel-polish/references/project-config-template.md`를 참조하여 형식을 맞춘다
