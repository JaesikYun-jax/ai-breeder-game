# novel-config.md — 「SSS급 저주에 걸린 짐꾼」
...
- **대화 비율 최소 15%** — 1인칭 도윤 단독 화에서도 인물 접점 의무
- **장문 비율 균형** — 4문장+ 연속 단락 한 화 5회 이하. 그 외엔 짧은 대사·반응으로 호흡 끊기
- **인물 접점 의무 위치**:
  - 짐꾼 등록·휴직 → 협회 직원 대화 (2~3턴)
  - 운동·자기단련 → 트레이너·사범 대화 (1~2턴)
  - 집 계약·부동산 → 중개인 대화 (1~2턴)
  - 은행·법인 거래 → 은행원·세무사 대화 (1~2턴)
  - 거래소·협회 인사이더 매수 → 직원 대화 (1~2턴)
  - 사설 조사관·정보원 → 결과 받을 때 대화 (2~3턴)
  - 헌터 후원 계약 → 신예 헌터 대화 (2~3턴)
- **목표**: 사람 냄새 나는 전개 / 가독성 회복 / 글자수 대비 호흡감
- **단, 도윤 보이스(건조·자조·짐꾼 출신·거래자)는 유지** — 도윤 발화는 그대로 짧고 건조
